...
from HydroRasterizationDialog import HydroRasterizationDialog

class HydroRasterization: 
  ...
  def initGui(self):  
    ...
    self.action = QAction(QIcon(":/plugins/HydroRasterization/icon.png"), \
